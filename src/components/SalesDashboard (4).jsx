...
<ResponsiveContainer width="100%" height={280}>
            ...
            <Panel dark={dark} title={null} className="fade-up">
              ...
              {/* Mobile: card list (below sm/640px) */}
              ...
              {/* Tablet/desktop: full table (sm/640px and up) */}
              <div className="hidden sm:block overflow-x-auto rounded-xl" style={{ border: `1px solid ${dark ? "rgba(255,255,255,0.05)" : "rgba(15,23,42,0.05)"}` }}>
